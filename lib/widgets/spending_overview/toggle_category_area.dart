...
class ToggleCategoryArea extends StatefulWidget {
  ...
  const ToggleCategoryArea({super.key, required this.isPortrait, required this.categories, required this.categoryColors});
        ...
        return ScrollbarTheme(
          ...
          child: Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                children: [
                  widget.isPortrait ? SizedBox(height: 2.h) : SizedBox(height: 5.h),
                  Wrap(
                      ...
                      for (int i = 0; i < widget.categories.length; i++)
                        Ink(
                          decoration: BoxDecoration(
                            boxShadow: [
                              BoxShadow(color: Colors.black.withValues(alpha: 0.9), offset: const Offset(3, 4), blurRadius: 15),
                              categoriesToggled.contains(widget.categories[i])
                                  ? BoxShadow(color: widget.categoryColors[i].withValues(alpha: 0.1), offset: const Offset(3, 3), blurRadius: 15)
                                  : BoxShadow(),
                            ],
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                ...
                                style: Centre.listText.copyWith(
                                  ...
                                  color: categoriesToggled.contains(widget.categories[i]) ? Centre.bgColor : widget.categoryColors[i],
                                ),
                              ),
                            ),
                          ),
